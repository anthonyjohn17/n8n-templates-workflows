...
> **Maintainer:** This package is part of a curated portfolio workspace. Source and issues: [anthonyjohn17 on GitHub](https://github.com/anthonyjohn17).  
> Individual workflow JSON files often come from third-party authors; check each template’s notes and your own compliance requirements before reuse.
>
## Support & contact

Questions about this collection or the bundled doc server: open a discussion or issue on **[github.com/anthonyjohn17](https://github.com/anthonyjohn17)** (link your clone to the repo name you publish).
...
cd n8n-templates-workflows/n8n-workflows
